...
1. APPLICATION_FORM_URLENCODED_VALUE 由 MultiValueMap 生成比较好
2. APPLICATION_FORM_URLENCODED_VALUE & @RequestParam 虽然也是body形式但是仍旧会被截断
3. JSON & 请求压缩时会有非法字符错误, https://blog.csdn.net/qq_33286757/article/details/147768083 
